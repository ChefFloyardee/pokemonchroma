...
MoveEnd:
	...
	move GROWTH,       ATTACK_UP1_EFFECT,            0, NORMAL,   100, 20
	...
	move BITE,         NO_ADDITIONAL_EFFECT,        65, FIRE,      95, 15 ; Fire Fang
	move EMBER,        RECOIL_EFFECT,              120, FIRE,     100, 15 ; Flare Blitz
	move FIRE_BLAST,   HYPER_BEAM_EFFECT,          150, FIRE,      90,  5 ; Blast Burn
	move BITE,         NO_ADDITIONAL_EFFECT,        65, ICE,       95, 15 ; Ice Fang
	move BITE,         NO_ADDITIONAL_EFFECT,        65, ELECTRIC,  95, 15 ; Thunder Fang
	...
	move TACKLE,       NO_ADDITIONAL_EFFECT,        20, ELECTRIC, 100, 20 ; Nuzzle
	move THUNDERBOLT,  PARALYZE_SIDE_EFFECT1,       80, ELECTRIC, 100, 15 ; Discharge
	move QUICK_ATTACK, NO_ADDITIONAL_EFFECT,       120, ELECTRIC, 100, 15 ; Volt Tackle
	move SURF,         NO_ADDITIONAL_EFFECT,        90, WATER,     85, 10 ; Muddy Water
	...
	move BITE,         NO_ADDITIONAL_EFFECT,        50, POISON,   100, 15 ; Poison Fang
	...
	move SAND_ATTACK,  NO_ADDITIONAL_EFFECT,        20, GROUND,   100, 10 ; Mud-Slap
	move SAND_ATTACK,  NO_ADDITIONAL_EFFECT,        65, GROUND,    85, 10 ; Mud Bomb
