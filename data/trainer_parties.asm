...
BugCatcherData:
	db 6
 	dw WEEDLE,CATERPIE,LEDYBA
 	db 0, 0
 
 	db 7
 	dw WEEDLE,KAKUNA,SPINARAK
 	db 0, 0
...
JrTrainerFData:
	db 19
 	...
 	db 19
 	dw PIDGEY,RATTATA,TOTODILE,BELLSPROUT
 	db 0, 0
 
 	db 28
 	dw GLOOM,ODDISH,BAYLEEF
 	db 0, 0
...
PokemaniacData:
	db 30
 	...
 	db 22
 	dw CHARMANDER,CUBONE,CYNDAQUIL
 	db 0, 0
...
SuperNerdData:
	db 11
 	...
 	db 34
 	dw PONYTA,CHARMANDER,VULPIX,QUILAVA
 	db 0, 0
...
BurglarData:
	...
	db 0, 0
 	...
 	db 34
 	dw CHARMANDER,CHARMELEON,CYNDAQUIL,QUILAVA
 	db 0, 0
...
FisherData:
	...
	dw GOLDEEN,TENTACOOL,GOLDEEN
 	...
 	db 17
 	dw TENTACOOL,STARYU,SHELLDER,CHINCHOU
 	db 0, 0
	...
	db 27
 	...
 	db 28
 	dw SEAKING,GOLDEEN,LANTURN,CHINCHOU
 	db 0, 0
...
SwimmerData:
	db 16
 	...
 	db 27
 	dw HORSEA,TENTACOOL,TOTODILE,GOLDEEN
 	db 0, 0
...
BeautyData:
    ...
    db 0, 0
 	...
 	db 29
 	dw BULBASAUR,IVYSAUR,CHIKORITA,BAYLEEF
 	db 0, 0
...
BirdKeeperData:
	db 29
 	...
 	db 25
 	dw SPEAROW,PIDGEY,HOOTHOOT,SPEAROW,SPEAROW
 	db 0, 0
	...
	db 26
 	...
 	db 26
 	dw SPEAROW,HOOTHOOT,FEAROW,SPEAROW
 	db 0, 0
 	...
 	db 26
 	dw PIDGEY,SPEAROW,NOCTOWL,FEAROW
 	db 0, 0
...
CooltrainerMData:
	db 39
 	...
 	db 43
 	dw KINGLER,TENTACRUEL,BLASTOISE,FERALIGATR
 	db 0, 0
